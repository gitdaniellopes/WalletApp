...
import br.com.walletapp.domain.usecase.CalculateListSumUseCase
import br.com.walletapp.domain.usecase.ParseTransactionValueInputUseCase
import br.com.walletapp.presentation.state.TransactionDialogState
import br.com.walletapp.presentation.state.TransactionType
import br.com.walletapp.presentation.state.TransactionUiItem
import br.com.walletapp.ui.theme.green
import br.com.walletapp.ui.theme.redOrange
import java.util.*
...
class WalletViewModel : ViewModel() {
    ...
    fun onTransactionValueChange(newValue: String) {
        ...
        transactionDialogState =
            transactionDialogState.copy(isConfirmButtonEnabled = validationResult)
    }
